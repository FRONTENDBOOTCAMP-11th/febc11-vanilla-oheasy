  ...
  build: {
    rollupOptions: {
      input: {
        ...
        signIn: resolve(__dirname, 'src/pages/auth/signIn_main.html'), // 로그인
        ...
        footer: resolve(__dirname, 'src/components/footer.html'), // footer 컴포넌트
        header: resolve(__dirname, 'src/components/header.html'), // header 컴포넌트
